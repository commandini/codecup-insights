      ...
      .then((data) => {
        ...
        new Tabulator("#table-container", {
          ...
          columns: [
            ...
            { title: "Total points", field: "points", sorter: "number", hozAlign: "right" },
            { title: "Maximum points", field: "maxPoints", sorter: "number", hozAlign: "right" },
            { title: "Minimum points", field: "minPoints", sorter: "number", hozAlign: "right" },
            {
            ...
            { title: "Draws", field: "draws", sorter: "number", hozAlign: "right" },
            { title: "Losses", field: "losses", sorter: "number", hozAlign: "right" },
            { title: "Fails", field: "fails", sorter: "number", hozAlign: "right" },
            {
              title: "Squeaker wins",
              field: "squeakerWins",
              sorter: "number",
